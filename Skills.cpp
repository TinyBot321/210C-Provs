...
void Skills() {
    ...
    chassis.moveToPoint(-29, 55.5, 1500, {.forwards = false});
    pros::delay(800);
    Hood.set_value(true);
    Stick.move_voltage(3900);
    pros::delay(1250);
    Stick.move_voltage(-3900);
    pros::delay(1250);
    Stick.move_voltage(0);
    chassis.moveToPoint(-67.4, 20, 1200, {.maxSpeed = 90});
    pros::delay(900);
    Match.set_value(true);
    Lift.set_value(false);
    Hood.set_value(false);
    chassis.turnToHeading(180, 900);
    chassis.moveToPoint(-67.6, 4.5, 2000, {.maxSpeed = 90});
    pros::delay(400);
    chassis.moveToPoint(-67.4, 20, 1000, {.forwards = false});
    chassis.turnToHeading(150, 1000);
    chassis.moveToPoint(-79, 35, 1000, {.forwards = false});
    pros::delay(800);
    Match.set_value(false);
    chassis.turnToHeading(180, 1000);
    chassis.moveToPoint(-79, 95, 1600, {.forwards = false, .maxSpeed = 100});
    chassis.moveToPoint(-64.5, 110, 2500, {.forwards = false, .maxSpeed = 100});
    chassis.turnToHeading(0, 1000);
    chassis.moveToPoint(-64.5, 91, 1000, {.forwards = false, .maxSpeed = 100});
    pros::delay(1000);
    Hood.set_value(true);
    ...
    // imu1.set_heading(90);
    chassis.moveToPoint(-64.5, 130, 2000, {.maxSpeed = 80});
    pros::delay(2300);
    chassis.moveToPoint(-64.5, 91.5, 1600, {.forwards = false, .maxSpeed = 100});
    pros::delay(800);
    Stick.move_voltage(9000);
    pros::delay(650);
    Stick.move_voltage(-9000);
    ...
    imu1.set_heading(90);
    chassis.moveToPoint(-64.5, 115, 2000, {.maxSpeed = 80});
    ...
    chassis.turnToHeading(90, 1000);
    chassis.moveToPoint(-36, 91, 1600, {.forwards = false});
    chassis.turnToHeading(135, 1000);
    chassis.moveToPoint(-23.5, 73.5, 1500);
    pros::delay(800);
